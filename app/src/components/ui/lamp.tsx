  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-4 bg-gradient-to-br from-gray-400 to-gray-700 py-4 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-7xl"
      >
        About us
      </motion.h1>
      <motion.h1
        ...
        className="mx-60 mt-4 bg-gradient-to-br from-gray-400 to-gray-700 py-4 bg-clip-text text-center text-lg font-medium tracking-tight text-transparent md:text-xl"
      >
        Toko Jaya Abadi adalah aplikasi resmi yang dirancang untuk memenuhi
        kebutuhan jual beli produk Apple dengan cara yang mudah, aman, dan
        terpercaya. Aplikasi ini menawarkan berbagai produk Apple terbaru,
        aksesoris, serta layanan pendukung, semuanya tersedia dalam satu
        platform yang intuitif dan user-friendly.
      </motion.h1>
    </LampContainer>
  );
}
